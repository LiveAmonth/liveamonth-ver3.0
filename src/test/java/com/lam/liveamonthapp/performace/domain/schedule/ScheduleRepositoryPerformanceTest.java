package com.lam.liveamonthapp.performace.domain.schedule;
...
import com.lam.liveamonthapp.bulk.schedule.ScheduleJdbcRepository;
...
@Transactional
@Slf4j
public class ScheduleRepositoryPerformanceTest {
